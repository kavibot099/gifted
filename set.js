...
global.footer = "*ᴘᴏᴡᴇʀᴅ ʙʏ ᴛʜᴇ ᴋᴀᴠɪ*"; // Input Yours custom...(Maintain font for Flow)
...
MODE: process.env.MODE || "groups", // Put private or public or inbox or groups
...
AUTO_READ_MESSAGES: process.env.AUTO_READ_MESSAGES || "falee", // Enter value to true for blueticking all messages, or commands for blueticking only commands else false
